...
import 'package:prog_mobile/view/telas_perfil/screenPerfil.dart';
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
        ...
        routes: {
          ...
          "/treinos/exercicios_registrados/criar_exercicio": (context) =>
              const ScreenCriarExercicio(),
          "/treinos/exercicios_treino": (context) =>
              const ScreenExerciciosTreino(),
          "/treinos/exercicios_treino/executar_treino": (context) =>
              const ScreenExecutarTreino(),
          "/treinos/exercicios_treino/adicionar_exercicio": (context) =>
              const ScreenCriarExercicio(),
          "/treinos/historico": (context) => const ScreenHistorico(),
          "/treinos/historico/historico_treino": (context) =>
